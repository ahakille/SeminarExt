codeunit 50100 "CSD Seminar-Post"
{
    ...
    begin
        ...
        with SeminarRegHeader do begin
            ...
            CopyCommentLines(SeminarCommentLine."Table Name"::"Seminar Registration Header", SeminarCommentLine."Table Name"::"Seminar Registration Header", "No.", PstdSeminarRegHeader."No.");
